...
CREATE TABLE `materials` (
  ...
  CONSTRAINT `materials_ibfk_1` FOREIGN KEY (`semester_id`) REFERENCES `semesters` (`id`),
  CONSTRAINT `materials_ibfk_2` FOREIGN KEY (`study_program_id`) REFERENCES `study_programs` (`id`),
  CONSTRAINT `materials_ibfk_3` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`)
