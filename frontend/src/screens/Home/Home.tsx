...
export const Home = ({ 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      {/* Header */}
      <header className="bg-gradient-to-r from-blueprime to-blue-700 shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <div className="flex items-center group cursor-pointer">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
                <div className="w-5 h-6 bg-gradient-to-br from-blueprime to-blue-700 rounded-sm"></div>
              </div>
      ...
      {/* Welcome Section */}
      <section className="bg-gradient-to-r from-blueprime to-blue-700 text-white py-12">
