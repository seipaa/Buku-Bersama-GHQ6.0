...
const getRatingDistribution = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-white min-h-screen">
      {/* Header */}
      <header className="w-full h-[60px] bg-blueprime shadow-lg">
        <nav className="flex justify-between items-center h-full px-4 lg:px-6">
          ...
          <div className="flex items-center group cursor-pointer">
            <img
              ...
              className="w-[25px] lg:w-[30px] h-[25px] lg:h-[30px] object-contain shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-110"
            />
